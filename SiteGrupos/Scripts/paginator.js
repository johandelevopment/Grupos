...
function paginator(config) {
    ...
    stat.innerHTML = "Pagina " + page + " de " + pages
        + ", registro " + (((page-1)*rows_per_page)+1)
        + " al " + (trs.length<page*rows_per_page||rows_per_page==0?trs.length:page*rows_per_page)
        + " de " + trs.length;
...
$(document).ready(function () {
    paginator({
        table: document.getElementById("divResultadosUsers").getElementsByTagName("table")[0],
