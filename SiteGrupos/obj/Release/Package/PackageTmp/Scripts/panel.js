...
$(document).ready(function () {
    ...
    var boton = "<form><script src='https://checkout.epayco.co/checkout.js'" +
        ...
        "data-epayco-response = 'https://pruebas.grupos.co/Transaccion/Resultado'" +
        "data-epayco-confirmation = 'https://pruebas.grupos.co/confirmacion'>" +
        "</script ></form>";
    ...
    $("#agregarVuelo").on('click', function () {
        ...
        $('#listVuelos').append(
            ...
            '<input type="date" id="fechaIda1" class="form-control">' +
            '</div>' +
            '</div>'
        );
        $('#eliminar').show();
                        ...
                        $('KIU_AirPriceRS', $xml).each(function () {
                            ...
                            if (TotalFare != undefined) {
                                ...
                                if (puestos_actual >= totalViajeros) {
                                    ...
                                    document.getElementById(id).innerHTML = "$" + TotalFare;
                    ...
                    $('KIU_AirAvailRS', $xml).each(function () {
                        ...
                        $(this).find("OriginDestinationInformation").each(function () { //Se recorren los nodos de la etiqueta KIU_AirAvailRS
                            if (index == 0) {
                                DepartureDateTime = $(this).find("DepartureDateTime").text();
                                fechaRegreso = new Date(DepartureDateTime);
                                textoFechaRegreso = (diasSemana[fechaRegreso.getDay() + 1] + ", " + (fechaRegreso.getDate() + 1) + " de " + meses[fechaRegreso.getMonth()] + " de " + fechaRegreso.getFullYear());
                                OriginLocation = $(this).find("OriginLocation").text();
                                DestinationLocation = $(this).find("DestinationLocation").text();
                                $("#divResultados #TableIda thead").append('<tr><th colspan=4><strong>IDA:  ' + textoFechaRegreso + '</strong><br/>' + textOrigen + '  -  ' + textDestino + '</th><th class="text-center"><strong>MINI</strong></th><th class="text-center"><strong>MAXI</strong><th class="text-center"><strong>SUPER</strong></th></th><th class="text-center"><strong>MEGA</strong></th>');
                                OriginDestinationOptions = $(this).find("OriginDestinationOptions");
                                OriginDestinationOptions.each(function () {//acceder a opciones
                                    vuelos = OriginDestinationOptions.find("FlightSegment");
                                    var v = 0; //Indice de cada vuelo
                                    ...
                                    vuelos.each(function () {//leear cada vuelo
                                        ...
                                        $("#divResultados #TableIda tbody").append('<tr><td>' + FDepartureDateTime.substring(11, 19) + '<br/>' + FArrivalDateTime.substring(11, 19) + '<td>' + textOrigen + '<br/>' + textDestino + '</td></td><td>' + FMarketingAirline + '<br/>' + FStopQuantity +
                                            '  ' + 'Paradas</td><td><a href="#">Ver detalle</a></td><td><input type="radio" id="IdaMiniOpc' + v + '" value="" /><p id="IdaMini' + v + '">$0.00</p><p id="IdaMiniPuestos' + v + '"> 0 Sillas</p></td><td><input type="radio" id="IdaMaxiOpc' + v + '" value="" /><p id="IdaMaxi' + v + '">$0.00</p><p id="IdaMaxiPuestos' + v + '"> 0 Sillas</p></td><td><input type="radio" id="IdaSuperOpc' + v + '" value="" /><p id="IdaSuper' + v + '">$0.0</p><p id="IdaSuperPuestos' + v + '"> 0 Sillas</p></td><td><input type="radio"'
                                            + ' id="IdaMegaOpc' + v + '" value="" /><p id="IdaMega' + v + '">$0.0</p><p id="IdaMegaPuestos' + v + '"> 0 Sillas</p></td>');
                                        v++;
                                    });
                                    ConsultaryPintarPrecios(arrayVuelos, OriginLocation, DestinationLocation, adultos, ninos, "Ida");
                                });
                            }
                            else {
                                DepartureDateTime = $(this).find("DepartureDateTime").text();
                                ...
                                OriginLocation = $(this).find("OriginLocation").text();
                                DestinationLocation = $(this).find("DestinationLocation").text();
                                $("#divResultados #TableRegreso thead").append('<tr><th colspan=4><strong>REGRESO:  ' + textoFechaRegreso + '</strong><br/>' + textDestino + '  -  ' + textOrigen + '</th><th class="text-center"><strong>MINI</strong></th><th class="text-center"><strong>MAXI</strong></th><th class="text-center"><strong>SUPER</strong></th><th class="text-center"><strong>MEGA</strong></th>');
                                OriginDestinationOptions = $(this).find("OriginDestinationOptions");
                                OriginDestinationOptions.each(function () {//acceder a opciones
                                    vuelos = OriginDestinationOptions.find("FlightSegment");
                                    var v = 0; //Indice de cada vuelo
                                    ...
                                    vuelos.each(function () {//leear cada vuelo
                                        ...
                                        $("#divResultados #TableRegreso tbody").append('<tr><td>' + FDepartureDateTime.substring(11, 19) + '<br/>' + FArrivalDateTime.substring(11, 19) + '<td>' + textDestino + '<br/>' + textOrigen + '</td></td><td>' + FMarketingAirline + '<br/>' + FStopQuantity +
                                            '  ' + 'Paradas</td><td><a href="#">Ver detalle</a></td><td><input type="radio" id="RegresoMiniOpc' + v + '" value="" /><p id="RegresoMini' + v + '">$0.00</p><p id="RegresoMiniPuestos' + v + '"> 0 Sillas</p></td><td><input type="radio" id="RegresoMaxiOpc' + v + '" value="" /><p id="RegresoMaxi' + v + '">$0.00</p><p id="RegresoMaxiPuestos' + v + '"> 0 Sillas</p></td><td><input type="radio" id="RegresoSuperOpc' + v + '" value="" /><p id="RegresoSuper' + v + '">$0.0</p><p id="RegresoSuperPuestos' + v + '">0 Sillas</p></td><td><input type="radio"'
                                            + ' id="RegresoMegaOpc' + v + '" value="" /><p id="RegresoMega' + v + '">$0.0</p><p id="RegresoMegaPuestos' + v + '"> 0 Sillas</p></td>');
                                        v++;
                                    });
                                    ConsultaryPintarPrecios(arrayVuelos, OriginLocation, DestinationLocation, adultos, ninos, "Regreso");
                                });
                            }
                            index++;
                        });
